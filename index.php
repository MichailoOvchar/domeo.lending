...
<body>
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item anchore">
                    <p><a href="#need">Вакансии</a></p>
                  </li>
                  <li class="nav-item anchore">
                    <p><a href="#condition ">Условия труда</a></p>
                  </li>
                  <li class="nav-item phone">
                    <p><a href="#modal">Заказать звонок</a></p>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <main>
        <section id="intro">
           <div class="container">
                ...
                <div class="content row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 info">
                        <p>
                            Официальное трудоустройство без московской прописки, <span>с зарплатой от 100 000₽ для мастеров со своим инструментом и опытом от 3-х лет</span>
                        </p>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 info-button-block">
                        <div class="info-button-block-text">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M39.5833 33.3333L29.1666 43.75L18.7499 33.3333" stroke="#FFDB48" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M29.1665 43.75L29.1665 27.0833C29.1665 15.5771 19.8394 6.25 8.33317 6.25L6.24984 6.25" stroke="#FFDB48" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <p><span>Узнайте прямо сейчас все актуальные вакансии</span> с белой зарплатой от 100 000₽</p>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title-text">
                        ...
                        <p>
                            если вы начнете работать с нами
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title">
                        <h3>
                            ...
                            <p>И получите постоянную работу с достойной зарплатой</p>
                        </h3>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row title">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 title-text">
                        <h2>
                            Даем <span>лучшие условия труда</span> для работы в Москве
                        </h2>
                        <p>
                            компенсируем высокие требования от мастеров лучшими условиями
                        </p>
                    </div>
                </div>
                <div class="blocks row owl-carousel">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>01</h4>
                            <p>Возможность работать вахтовым методом</p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>02</h4>
                            <p>Компенсируем затраты на проезд и гсм к удаленным объектам</p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>03</h4>
                            <p>Погрузку-разгрузку выполняют только подрядчики, а не мастера</p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>04</h4>
                            <p>Сертификация и квалификации от производителей Knauf, Tikkurila, Rehau и др.</p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>05</h4>
                            <p>Карьерный рост до: бригадира, прораба, начальника участка и так далее</p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>06</h4>
                            <p>Прямой контакт с руководством компании для решения любых финансовых вопросов </p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>07</h4>
                            <p>Внедрение инновационных материалов и технологий для облегчения труда</p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>08</h4>
                            <p>Корпоративная спец. одежда</p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>09</h4>
                            <p>Объекты подбираются ближе к вашему месту жительства</p>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="shadow-box">
                            <h4>10</h4>
                            <p>100% загрузка работой без простоев</p>
                        </div>
                    </div>
                </div>
        ...
        <section id="four-step">
            <div class="title">
                <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title-text">
                        <h2>
                            Устройтесь на работу вашей мечты за <span>4 шага</span>
                        </h2>
                        <p>
                            самое главное начать, ведь места ограничены
                        </p>
                    </div>
                </div>
                </div>
            ...
            <div class="container form-section">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title">
                        <h3>
                            Сделайте первый шаг!
                            <p>Мы перезвоним вам и назначим собеседование</p>
                        </h3>
                    </div>
                </div>
                <form action="/ajax/ajax.php" data-thanks="/thanks-page.php">
        ...
        <section id="job">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title-text">
                        <h2>
                            Ваша работа может состоять из:
                        </h2>
                        <p>
                            все зависит от вашей профессии и навыков
                        </p>
                    </div>
                </div>
                <div class="row picture-box">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 text">
                        <div class="left"></div>
                        <p>
                        Чистовые и черновые работы
                        </p>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 text before">
                        <div class="right"></div>
                        <p>
        ...
        <section id="question">
            <div class="title-head">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title-text">
                        <h2>
                            <span>Запишитесь прямо сейчас</span> на онлайн собеседование
                        </h2>
                        <p>
                        мы перезвоним вам с уточняющими вопросами в течении 30 минут после заявки
                        </p>
                    </div>
                </div>
                </div>
            ...
            <div class="container">
                <div class="row interview">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="list">
                            <p>Во время собеседования мы у вас спросим:</p>
                            <ul>
                                <li><img src="./img/icon/carbon_document-unknown.svg" alt="doc"><span>Где вы живете территориально, и как планируете работать в Москве? </span></li>
                                <li><img src="./img/icon/carbon_document-unknown.svg" alt="doc"><span>Какую работу в ремонте квартир вы можете выполнять качественно?</span></li>
                                <li><img src="./img/icon/carbon_document-unknown.svg" alt="doc"><span>Есть ли у вас инструмент и опыт работы в ремонтах квартир?</span></li>
                                <li><img src="./img/icon/carbon_document-unknown.svg" alt="doc"><span>Какую зарплату вы хотите получать?</span></li>
                                <li><img src="./img/icon/carbon_document-unknown.svg" alt="doc"><span>И еще пару вопросов</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        ...
                        <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title">
                                    <h3>
                                        Заполните форму!
                                        <p>Запишитесь на онлайн собеседование!</p>
                                    </h3>
                                </div>
                            </div>
                            <form action="/ajax/ajax.php" data-thanks="/thanks-page.php">
                ...
                <div class="row massege">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 alert-massege">
                        <p><span>Если вас устроят все условия работы, вы можете выйти на объект уже на следующий день</span></p>
                    </div>
                </div>
            </div>
        </section>
        <section id="about">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title-text">
                        <h2>
                        Мы не обманем вас с зарплатой и другими договоренностями
                        </h2>
                        <p>
                        мы не хотим портить свою репутацию и "экологичность" компании
                        </p>
                    </div>
                </div>
                <div class="row content">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 text">
                        ...
                        <p>За это время мы создали бизнес-структуру, которая работает как дорогие швейцарские часы.</p>
                        <p>Секрет нашего успеха в самых лучших условиях и высокой зарплате для мастеров, в честности и прозрачности с людьми.</p>
                        <p>Мы ценим мастеров с большим опытом, а также создаём все условия для качественной работы.</p>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="row massege">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 label">
                                <p>
                                    Присоединяйтесь к нам прямо сейчас!
                                </p>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 massege-text">
                                <p>Мы ищем людей на постоянную работу. Нам нужны мастера для сотрудничества на долгие годы.</p>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 massege-button">
                                <a href="#modal" class="button">
        ...
        <section id="map">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title-text">
                        <h2>
                        Вы всегда можете прийти к нам<br/><span>в офис для личного знакомства</span>
                        </h2>
                        <p>
                        мы с радостью вас встретим и обсудим условия работы
                        </p>
                    </div>
                </div>
                <div class="row content">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-11 col-xl-11 map-box">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2247.4934829344365!2d37.572224916131134!3d55.71517568054326!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46b54b78fd7e4153%3A0xa539d5d81b7e2873!2z0JvRg9C20L3QtdGG0LrQsNGPINC90LDQsS4sIDIvNCwg0JzQvtGB0LrQstCwLCDQoNC-0YHRltGPLCAxMTkyNzA!5e0!3m2!1suk!2sua!4v1624526233364!5m2!1suk!2sua" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        <div class="map-info">
                            <h5>
                                Адрес офиса:
                            </h5>
                            <p>    
                                г. Москва, ул. Лужнецкая наб. 2/4 стр. 17, офис 308
                            </p>
                            <h5>
                                Контактный телефон:
                            </h5>
                        ...
                        <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title">
                                    <h3>
                                        ...
                                        <p>Сегодня мы с Вами свяжемся по указанному номеру</p>
                                    </h3>
                                </div>
                            </div>
                            <form action="/ajax/ajax.php" data-thanks="/thanks-page.php">
